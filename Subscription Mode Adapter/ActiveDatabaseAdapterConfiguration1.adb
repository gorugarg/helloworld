...
<Repository:repository xmlns:Repository="http://www.tibco.com/xmlns/repo/types/2002" xmlns:AESDK="http://www.tibco.com/xmlns/aemeta/adapter/2002" xmlns:AEService="http://www.tibco.com/xmlns/aemeta/services/2002" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
    <ADB:adapter xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002" name="ActiveDatabaseAdapterConfiguration1">
        <AESDK:instanceId>ActiveDatabaseAdapterConfiguration1</AESDK:instanceId>
        <AESDK:startup>
        ...
        <AESDK:metadata>
            ...
            <AESDK:loadUrl isRef="true">/AESchemas/ae/ADB/ActiveDatabaseAdapterConfiguration1.aeschema</AESDK:loadUrl>
        </AESDK:metadata>
        ...
        <ADB:operations xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002">
            <ADB:subscriber xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002" resourceType="adb.table.subscriber">
                ...
                <ADB:classReference isRef="true">/AESchemas/ae/ADB/ActiveDatabaseAdapterConfiguration1.aeschema#class.CUSTOMERS</ADB:classReference>
                ...
                <ADB:userDefinedKey>CUSTOMER_ID</ADB:userDefinedKey>
                <ADB:schemas xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002">
                    <ADB:table xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002">
                        ...
                        <ADB:userKeys>CUSTOMER_ID</ADB:userKeys>
                    </ADB:table>
                </ADB:schemas>
                <ADB:destination>%%Domain%%.%%Deployment%%.adb.ActiveDatabaseAdapterConfiguration1.ADBSubscriber</ADB:destination>
                ...
                <ADB:sessionReference>/Subscription Mode Adapter/ActiveDatabaseAdapterConfiguration1.adb#jmsSession.JMSQueue</ADB:sessionReference>
                <ADB:useOpqExcpTable>on</ADB:useOpqExcpTable>
                <ADB:exceptionsTable>EXCEPTION</ADB:exceptionsTable>
                <ADB:opqExcpTable>OPAQUEEXCEPTION</ADB:opqExcpTable>
            </ADB:subscriber>
        </ADB:operations>
        <ADB:activedb xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002">
            <ADB:defaultDataSource xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002">
                ...
                <ADB:password>#!s+zdVbiE+IY1oc1KwR+axKEIvenkffLa0gucjDMpxBY=</ADB:password>
            ...
            <ADB:agentOptions xmlns:ADB="http://www.tibco.com/xmlns/adapter/ADB/2002">
                ...
                <ADB:scriptFileName>%%ADBScriptFileDir%%\ActiveDatabaseAdapterConfiguration1.sql</ADB:scriptFileName>
    ...
    <AEService:jmsConsumer xmlns:AEService="http://www.tibco.com/xmlns/aemeta/services/2002" objectType="endpoint.JMSSubscriber" name="ADBSubscriber">
        ...
        <AEService:destination>%%Domain%%.%%Deployment%%.adb.ActiveDatabaseAdapterConfiguration1.ADBSubscriber</AEService:destination>
        <AEService:class isRef="true">/AESchemas/ae/ADB/ActiveDatabaseAdapterConfiguration1.aeschema#class.CUSTOMERS</AEService:class>
